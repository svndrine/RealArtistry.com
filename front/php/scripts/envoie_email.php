...
try { 
    ...
    if(isset($_SESSION['pseudo']) && isset($_SESSION['key']) && isset($_SESSION['email'])) {
        $mail->addAddress($_SESSION['email']);    // Ajouter l'adresse du destinataire
        $mail->Subject = 'Confirmation de votre email';    // Definir le sujet de l'email
        $mail->Body = '<html>
                            <body>
                                <div align="center">
                                    <a href="confirmation.php?pseudo=' . urlencode($_SESSION['pseudo']) . '&key=' . $_SESSION['key'] . '">Cliquez ici pour confirmer votre compte !</a>
                                </div>
                            </body>
                        </html>';
