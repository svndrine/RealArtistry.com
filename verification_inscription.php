...
$sql = "INSERT INTO USERS (code, first_name, name, pseudo, password, date_of_birth, gender, email, country, n, street, city, postal_code, category, profil_picture, confirm_key) 
        VALUES (:code, :first_name, :name, :pseudo, :password, :date_of_birth, :gender, :email, :country, :n, :street, :city, :postal_code, :category, :profil_picture, :confirm_key)";
$stmt = $bdd->prepare($sql);
$stmt->execute([
...
header('Location: envoie_email.php?email='.$_POST['email'].'&pseudo='.$_POST['pseudo'].'&key='.$key);
exit;
